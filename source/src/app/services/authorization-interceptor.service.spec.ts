...
describe('AuthorizationInterceptorService', () => {
  ...
  it(
    'should add Authorization header to the request',
    waitForAsync(() => {
  ...
  it(
    'should include exp & nbf in the payload',
    waitForAsync(() => {
      const cryptoService: RS256CryptoService = TestBed.inject(
        RS256CryptoService
      );
  ...
  it(
    'should not add Authorization header to the request when signature is not available',
    waitForAsync(() => {
      const cryptoService: RS256CryptoService = TestBed.inject(
        RS256CryptoService
      );
